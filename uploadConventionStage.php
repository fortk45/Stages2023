...
if (isset($_FILES["convention"])){
    ...
    $filename = $_FILES["convention"]["name"];
    $filetmpname = $_FILES["convention"]["tmp_name"];
    $filesize = $_FILES["convention"]["size"];
    ...
    // Vérifiez si il y a eu une erreur lors de l'upload
        ...
        if ($filesize < 2000000) {
            ...
            $fileDestination = 'justificatifs/convention/' . $newname;
            ...
            $insert = "UPDATE sta_etudiant SET convention = '$newname' WHERE idetudiant = $idEtudiant";
