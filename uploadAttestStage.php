...
if (isset($_FILES["attestStage"])){
    ...
    $filename = $_FILES["attestStage"]["name"];
    $filetmpname = $_FILES["attestStage"]["tmp_name"];
    $filesize = $_FILES["attestStage"]["size"];
    ...
    // Vérifiez si il y a eu une erreur lors de l'upload
        ...
        if ($filesize < 2000000) {
            ...
            $fileDestination = 'justificatifs/attestation/' . $newname;
            ...
            $insert = "UPDATE sta_etudiant SET attestStage = '$newname' WHERE idetudiant = $idEtudiant";
