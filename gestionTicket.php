...
if (isset($_GET['suppTicket'])){
    ...
    echo '<div class="alert alert-danger" role="alert">Le ticket a été supprimé.</div>';
}
...
if (isset($_GET['check'])){
    ...
    echo '<div class="alert alert-danger" role="alert">Le ticket a été traité.</div>';
}

// REQUETE

$sqlticket2 = "SELECT * FROM sta_ticket t, sta_etudiant e WHERE t.id_etudiant=e.idetudiant AND statut not in ('Résolu') ORDER BY t.date_ticket asc";
                    ...
                    <table class="table table-striped">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><img width="80" src="img/avatar/<?php echo $photoEtudiant?>"> <?php echo $nomEtudiant;?></td>
